...
TOKEN = "8694643746:AAFTChNAmKHQJFH0GdqudDdEU15XEMll3Uw"
...
async def admin_reject_confirm(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reasons = {
        "1": "📏 <b>Спавн не подходит.</b>\nСлишком большой, не соответствует правилам или не указан чётко. Уточни место спавна и попробуй снова.",
        "2": "📛 <b>Название не подходит.</b>\nВыбери другое название для страны, которое соответствует сеттингу РП."
    }
