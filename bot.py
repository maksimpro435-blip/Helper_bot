...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "enter_rp":
        ...
        text = (
            ...
            "Не спорь с ним. Не предавай нас.\n\n"
        ...
        text = (
            ...
            "🎯 Цель: развить страну, решить проблемы, выжить.\n"
            ...
            "━━━━━━━━━━━━━━━━━━\n\n"
            "📌 <b>4. ЗАПРЕТ НА ИМБУ</b>\n\n"
            "❌ Мгновенное развитие ❌ Армия с нуля\n"
            "❌ Захват мира за день ❌ Игнор экономики\n\n"
            "━━━━━━━━━━━━━━━━━━\n\n"
